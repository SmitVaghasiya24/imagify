  ...
  return (
    ...
    >
      <div>
        ...
        <marquee direction="right" className={!loading ? 'hidden' : ''}>Loading....... </marquee>
      </div>

      {
        !isImageLoaded &&
        <div className="flex w-full text-white max-w-xl bg-neutral-500 text-sm p-0.5 mt-10 rounded-full">
