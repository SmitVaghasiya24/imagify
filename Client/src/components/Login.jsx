    ...
    return (
        <div className="fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
            <motion.form
                ...
                className="relative bg-white p-6 sm:p-10 rounded-xl text-slate-500 w-full sm:w-auto max-w-lg mx-4"
            ...
            >
                ...
                <p className="text-sm text-center sm:text-left">Welcome back! Please sign in to continue</p>
                ...
                <img
                    ...
                    alt=""
                    className="absolute top-5 right-5 cursor-pointer w-6 h-6 sm:w-8 sm:h-8"
